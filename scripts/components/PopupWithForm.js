...
export default class PopupWithForm extends Popup {
    constructor(popupElemSelector, handleFormSubmit) {
        ...
        this._formElem = super._popupElem.querySelector(".popup__form");
    ...
    _getInputValues() {
        ...
        this._nameInputValue = super._popupElem.querySelector(".popup__input_type_name").value;
        this._infoInputValue = super._popupElem.querySelector(".popup__input_type_info").value;
    }
}
